...
/* harmony import */ var _editingTask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editingTask */ "./src/editingTask.js");
/* harmony import */ var _editingProject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editingProject */ "./src/editingProject.js");
...
const addProject = (dataProject, textInput) => {
    ...
    (0,_dragAndDrop__WEBPACK_IMPORTED_MODULE_3__.dragStartEndEvent)(container);
}
...
function checkTile(e){
    ...
    if(homeTile != null){
        ...
        selectTile(homeTile);
        (0,_editingProject__WEBPACK_IMPORTED_MODULE_2__.revertOptionLocation)();
        (0,_homeSection__WEBPACK_IMPORTED_MODULE_4__.checkWhichHomeTile)(homeTile);
        ...
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.revertEditFormLocation)();               //move form or option of task to original place on standby.   
        (0,_editingProject__WEBPACK_IMPORTED_MODULE_2__.revertOptionLocation)();
...
function checkListEvent(e){
    ...
    if(isStarIcon){
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.styleImportantTask)(e);
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.updateImportantTask)(e);
    }
    else if(isCircleIcon){
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.styleCompletedTask)(e);
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.updateCompletedTask)(e);
    }
    else if(isDeleteBtn){
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.deleteTask)(e);
    }
    else if(isEditBtn){
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.showEditForm)(e);
    }
    else if(isEditSubmitBtn){
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.processEditTask)(e);
    }
    else if(isEditTaskCancel){
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.revertEditFormLocation)();
        (0,_editingTask__WEBPACK_IMPORTED_MODULE_1__.showHiddenTask)();
    }
    else{
        return;
    }
...
function addTask(listId, title, details, date, completed, important){
    ...
    const starOutline = (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.createSpanIcon)("star_outline");
    starOutline.classList.add("star-outline");
    listRight.appendChild(starOutline);

    const star = (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.createSpanIcon)("star");
...
/* harmony export */   dragStartEndEvent: () => (/* binding */ dragStartEndEvent)
/* harmony export */ });
/* harmony import */ var _creatingProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./creatingProject */ "./src/creatingProject.js");
/* harmony import */ var _editingProject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editingProject */ "./src/editingProject.js");
...
function dragStartEndEvent(tile){
    ...
    tile.addEventListener("dragend", () =>{
        ...
        (0,_editingProject__WEBPACK_IMPORTED_MODULE_1__.sortArray)();
        console.log(_creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList);
    });
}
...
//find the closest projectTile to the cursor
...
/* harmony export */   editContainerEventListener: () => (/* binding */ editContainerEventListener),
/* harmony export */   hideDropDown: () => (/* binding */ hideDropDown),
/* harmony export */   revertOptionLocation: () => (/* binding */ revertOptionLocation),
/* harmony export */   showRenameForm: () => (/* binding */ showRenameForm),
...
const processRenameInput = (e) =>{
    ...
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList[dataNum].name = renameInput;
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();

    displayRenamedProject();
    (0,_creatingTask__WEBPACK_IMPORTED_MODULE_1__.updateTitle)(projectName);           //update title on right panel
    revertRenameFormLocation();
}
...
const deleteProject = (e) => {
    ...
    if(tile.classList.contains("selected")){                //if the tile you want to delete is selected always select the today tile after and update 
        ...
        (0,_creatingTask__WEBPACK_IMPORTED_MODULE_1__.updateTitle)(nameNode);    
    }

    revertOptionLocation(e);                                 //when delete a tile, move option div back to under project for stand by
    tile.remove();
    sortArray();
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList.splice(index,1);
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();
}
...
function sortArray(){
    ...
    tiles.forEach((tile) =>{
        ...
        _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList[dataNum].dataProject = i;
        i++;
    });
    //reorder projects according to their dataProject nunmber
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList.sort((a,b) => a.dataProject - b.dataProject);
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();
}
...
/* harmony export */   relocateEditListForm: () => (/* binding */ relocateEditListForm),
/* harmony export */   revertEditFormLocation: () => (/* binding */ revertEditFormLocation),
/* harmony export */   showEditForm: () => (/* binding */ showEditForm),
/* harmony export */   showHiddenTask: () => (/* binding */ showHiddenTask),
/* harmony export */   styleCompletedTask: () => (/* binding */ styleCompletedTask),
/* harmony export */   styleImportantTask: () => (/* binding */ styleImportantTask),
/* harmony export */   updateCompletedTask: () => (/* binding */ updateCompletedTask),
/* harmony export */   updateImportantTask: () => (/* binding */ updateImportantTask)
/* harmony export */ });
/* harmony import */ var _creatingProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./creatingProject */ "./src/creatingProject.js");
/* harmony import */ var _editingProject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editingProject */ "./src/editingProject.js");
/* harmony import */ var _creatingTask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./creatingTask */ "./src/creatingTask.js");
/* harmony import */ var _homeSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./homeSection */ "./src/homeSection.js");
...
function updateImportantTask(e){
    ...
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();
    (0,_editingProject__WEBPACK_IMPORTED_MODULE_1__.revertOptionLocation)();
...
function deleteTask(e){
    ...
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList[dataProject].taskList =  _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList[dataProject].taskList.filter(task => task != selectedTask);
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();
    (0,_editingProject__WEBPACK_IMPORTED_MODULE_1__.revertOptionLocation)();
    listNode.remove();
}
...
function findSelectedTask(listId){
    let selectedTask = _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList.reduce((acc, project) =>{
...
function processEditTask(e){
    ...
    selectedTask.date = (0,_creatingTask__WEBPACK_IMPORTED_MODULE_2__.processDateData)(dateInput);
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();
...
function refreshDisplay(dataProject){
    ...
    if(selectedTile.closest(".project") != null){
        (0,_creatingTask__WEBPACK_IMPORTED_MODULE_2__.displayTask)(dataProject);
    }
    else if(selectedTile.closest(".home") != null){
        (0,_homeSection__WEBPACK_IMPORTED_MODULE_3__.checkWhichHomeTile)(selectedTile);
    }
    else{
        return;
    }
...
function showEditForm(e){
    let editContainerNode = e.target.parentNode.parentNode;
    (0,_editingProject__WEBPACK_IMPORTED_MODULE_1__.hideDropDown)(editContainerNode);
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isEqual.mjs");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/addDays.mjs");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isWithinInterval.mjs");
/* harmony import */ var date_fns_parseISO__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns/parseISO */ "./node_modules/date-fns/parseISO.mjs");
/* harmony import */ var _creatingProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./creatingProject */ "./src/creatingProject.js");
/* harmony import */ var _creatingTask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./creatingTask */ "./src/creatingTask.js");
...
function displayAllTasks(){
    clearContent();
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList.forEach((project) =>{
        project.taskList.forEach((task) => {
            (0,_creatingTask__WEBPACK_IMPORTED_MODULE_1__.addTask)(task.id, task.title, task.details, task.date,task.completed, task.important);
        });
    });
    (0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.hideAddTaskBtn)();
    checkNoTask();
};
...
function displayToday(){
    clearContent();
    let today = Date.parse((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(), "yyyy-MM-dd"));           //parse for comparison and format so it has the same format before parsing it
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList.forEach((project) =>{
        project.taskList.forEach((task) => {
            let date = Date.parse(task.date);
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isEqual)(date, today)){
                (0,_creatingTask__WEBPACK_IMPORTED_MODULE_1__.addTask)(task.id, task.title, task.details, task.date,task.completed, task.important);
            }
            else{
                return;
...
function displayThisWeek(){
    ...
    _creatingProject__WEBPACK_IMPORTED_MODULE_0__.projectList.forEach((project) =>{
        project.taskList.forEach((task) => {
            let date = (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date);
...
function checkNextWeek(taskDate){
    let nextWeekPlus1 = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.addDays)(new Date(), 8);         //interval does not count the edges so plus 1
    let today = new Date();
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.isWithinInterval)(taskDate,{
        start: today,
        end: nextWeekPlus1
    });
}
...
(0,_creatingTask__WEBPACK_IMPORTED_MODULE_1__.listEvent)();
(0,_creatingProject__WEBPACK_IMPORTED_MODULE_0__.createEventListener)();
(0,_editingProject__WEBPACK_IMPORTED_MODULE_2__.editContainerEventListener)();
(0,_dragAndDrop__WEBPACK_IMPORTED_MODULE_3__.dragAndDropEvent)();
(0,_homeSection__WEBPACK_IMPORTED_MODULE_4__.displayAllTasks)();
